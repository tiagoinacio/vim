...
inoremap <silent> <SNR>108_AutoPairsReturn =AutoPairsReturn()
...
nmap 		 :GitGutterPrevHunk
nmap 	 :GitGutterNextHunk
...
xmap <silent> , <Plug>fanfingtastic_,
nnoremap , :
nmap - dd
...
map :Q :q
nmap :W :w
nmap <silent> ; <Plug>fanfingtastic_;
vmap ; :B 
nnoremap <silent> >> :call ShiftLine()
nmap @ :YRMapsMacro
...
xmap <silent> F <Plug>fanfingtastic_F
nmap <silent> F <Plug>fanfingtastic_F
nnoremap H :bp
nnoremap J 2j
imap ˇ ha
nnoremap K 2k
...
xmap <silent> T <Plug>fanfingtastic_T
nmap <silent> T <Plug>fanfingtastic_T
vmap [% [%m'gv``
nnoremap \d :YcmShowDetailedDiagnostic
nnoremap \bst :B2BUnitTest()
nnoremap \bsf :B2BSwap()
nnoremap \bdb :B2BDiff()
nmap \tg :TagbarToggle
nnoremap <silent> \dt :ProjectRootExe NERDTreeFind
...
noremap \gn :GitGutterNextHunk
noremap \gr :GitGutterRevertHunk
noremap \gs :GitGutterStageHunk
noremap \gp :GitGutterPrevHunk
noremap \h- :resize -10
noremap \h+ :resize +10
noremap \++ :vertical resize +20
noremap \-- :vertical resize -20 "resize current buffer by +/- 5
noremap \v+ :vertical resize +10
...
noremap \tt :TernType
noremap \td :TernDef
noremap \sy :SyntasticCheck jslint
noremap \si :SyntasticInfo
noremap \re :TernRename
noremap \ln :lnext
noremap \ls :ls
noremap \g :grep! "\b\b":cw
noremap \ne :NERDTreeToggle
noremap \do :JsDoc
noremap \sn :CtrlSpaceTabLabel
noremap \st :CtrlSpace l
noremap \sb :CtrlSpace
noremap \ct :CtrlPSmartTabs
noremap \cb :CtrlPBuffer
noremap \tc :CtrlPBufTag
noremap \tb :CtrlPBufTagAll
noremap \ta :CtrlPTag
noremap \	 :CtrlP
noremap \bo :CtrlPBookmarkDir
noremap \cp :CtrlPCurWD
map \gf 
nmap \ss :CtrlSpace
nmap \b9 :b9
nmap \b8 :b8
...
set wildignore=*/tmp/*,*.so,*.swp,*.zip,target/*,*/node_modules/*,*/.git/*,blender/*,baseChanges/*
set wildmenu
set winheight=999
set winwidth=84
...
silent only
cd ~/Work/betfair/bf-edw-functional-tests-nj
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/Work/betfair/bf-edw-functional-tests-nj/protractor.conf.js
badd +1 ~/Work/betfair/bf-edw-functional-tests-nj/protractor.overrides.js
argglobal
silent! argdel *
edit ~/Work/betfair/bf-edw-functional-tests-nj/protractor.overrides.js
